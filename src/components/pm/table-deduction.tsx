...
interface ITablePayrollDeductionProps{
    payrollDeductions: IPayrollDeduction[];
}

function TabPayrollDeduction({payrollDeductions}: ITablePayrollDeductionProps){
    ...
    return(
        <section className="w-full py-4">
            <div className="grid grid-cols-4 gap-4">
                { payrollDeductions &&payrollDeductions.map((item: IPayrollDeduction, index) => (
...
export default TabPayrollDeduction;