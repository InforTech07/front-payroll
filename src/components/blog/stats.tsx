...
function Stats(){
    return(
        <div id="solution" className="space-y-40 mb-40">
            <ContainerBlog>
                ...
                <div className="space-y-6 justify-between text-gray-600 md:flex flex-row-reverse md:gap-6 md:space-y-0 lg:gap-12 lg:items-center">
                    ...
                    <h2 className="text-3xl font-bold text-gray-900 md:text-4xl dark:text-white">Rendimiento de nuestra plataforma</h2>
                    <p className="my-8 text-gray-600 dark:text-gray-300">Nobis minus voluptatibus pariatur dignissimos libero quaerat iure expedita at?
                    ...
                    <div className="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
                        ...
                        <div className="w-5/6">
                            <h3 className="font-semibold text-lg text-gray-700 dark:text-indigo-300">Soporte a toda hora</h3>
                        ...
                        <div className="w-5/6">
                            <h3 className="font-semibold text-lg text-gray-700 dark:text-teal-300">Datos en tiempo real</h3>
                            <p className="text-gray-500 dark:text-gray-400">Asperiores nemo possimus nesciunt quam mollitia.</p>
                        </div> 
                        </div> 
                    </div>
