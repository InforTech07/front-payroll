...
import { deleteDepartment } from "@/redux/hrm/department-slice";
                ...
                { [1,2,3,4,5,6,7,8,9].map((item, index) => (
                    <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg">
                        ...
                        <div className="px-4 py-2">
                            <h1 className="text-sm text-gray-700">Patterson johnson</h1>
                            <div className="flex items-center mt-2 text-gray-700">
                                ...
                                <h1 className="px-2 text-xs">Meraki UI</h1>
                            </div>
                            ...
                            <div className="flex items-center mt-2 text-gray-700">
                                ...
                                <h1 className="px-2 text-xs">California</h1>
                            </div>
                            ...
                            <div className="flex items-center mt-2 text-gray-700">
                                ...
                                <h1 className="px-2 text-xs">patterson@example.com</h1>
                            </div>
                        </div>
                        <div className="flex items-center px-4 py-2">
                            <div className="flex overflow-hidden bg-white border divide-x rounded-lg rtl:flex-row-reverse">
                                <button className="px-2 py-2 text-xs text-gray-600 transition-colors duration-200 sm:text-base sm:px-4 hover:bg-gray-100">
                                    Detalles
                                </button>
